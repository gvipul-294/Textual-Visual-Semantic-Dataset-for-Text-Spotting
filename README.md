...
`Visual Re-ranking with Natural Language Understanding for Text Spotting` [paper](https://arxiv.org/pdf/1810.12738.pdf) [code](https://github.com/ahmedssabir/Visual-Semantic-Relatedness-with-Word-Embedding)
